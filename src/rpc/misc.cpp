...
UniValue insync(const UniValue& params, bool fHelp)
{
    ...
    if(strMode == "status") {
        ...
        objStatus.push_back(Pair("AssetID", fivegnodeSync.GetAssetID()));
        objStatus.push_back(Pair("AssetName", fivegnodeSync.GetAssetName()));
        objStatus.push_back(Pair("Attempt", fivegnodeSync.GetAttempt()));
        objStatus.push_back(Pair("IsBlockchainSynced", fivegnodeSync.GetBlockchainSynced()));
        objStatus.push_back(Pair("IsFivegnodeListSynced", fivegnodeSync.IsFivegnodeListSynced()));
        objStatus.push_back(Pair("IsWinnersListSynced", fivegnodeSync.IsWinnersListSynced()));
        objStatus.push_back(Pair("IsSynced", fivegnodeSync.IsSynced()));
        objStatus.push_back(Pair("IsFailed", fivegnodeSync.IsFailed()));
        return objStatus;
    }
    ...
    if(strMode == "next")
    {
        ...
        return "sync updated to " + fivegnodeSync.GetAssetName();
    }

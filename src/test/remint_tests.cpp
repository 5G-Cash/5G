...
BOOST_AUTO_TEST_CASE(remint_basic_test)
{
    ...
    // spend coin for 100 vgc
    BOOST_CHECK_MESSAGE(pwalletMain->CreateZerocoinSpendModel(stringError, "", "100", false, true), stringError + " - 100 vgc spend failed");
    CreateAndProcessBlock({}, scriptPubKey);
    ...
    // Try remint for 100 vgc. Again should pass

...
extern const char *FIVEGNODEPAYMENTVOTE;
extern const char *FIVEGNODEPAYMENTSYNC;
...
enum GetDataMsg
{
    ...
    MSG_SPORK,
    MSG_FIVEGNODE_PAYMENT_VOTE,
    MSG_FIVEGNODE_PAYMENT_BLOCK,
    MSG_FIVEGNODE_ANNOUNCE,
    MSG_FIVEGNODE_PING,
    MSG_FIVEGNODE_VERIFY,
    MSG_TXLOCK_REQUEST,
    MSG_TXLOCK_VOTE,
    MSG_DSTX,
    DSQUEUE,

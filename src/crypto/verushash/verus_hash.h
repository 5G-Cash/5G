...
/*
This provides the PoW hash function for 5GCash, enabling CPU mining.
*/
...
class CVerusHashV2
{
    public:
        ...
        CVerusHashV2(int solutionVersion=SOLUTION_VERUSHHASH_V2_2) : vclh(VERUSKEYSIZE, solutionVersion) {

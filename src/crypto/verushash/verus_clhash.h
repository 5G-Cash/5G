...
enum {
    ...
    SOLUTION_VERUSHHASH_V2_2 = 4         // Verushash v2.2
};
...
struct verusclhasher {
    ...
    verusclhasher(uint64_t keysize=VERUSKEYSIZE, int solutionVersion=SOLUTION_VERUSHHASH_V2_2) : keySizeInBytes((keysize >> 5) << 5)
    {
#ifdef __APPLE__
       __tls_init();
#endif

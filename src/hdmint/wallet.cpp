 ...
 *
 * See https://github.com/FivegXProject/Fiveg/pull/392 for specification on mint generation.
 * 
...
{
    if(!fivegnodeSync.IsBlockchainSynced() && !fAllowUnsynced && !(Params().NetworkIDString() == CBaseChainParams::REGTEST))

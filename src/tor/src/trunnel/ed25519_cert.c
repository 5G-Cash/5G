...
uint8_t
create2_cell_body_get_handshake_data(create2_cell_body_t *inp, size_t vgc)
{
  return TRUNNEL_DYNARRAY_GET(&inp->handshake_data, vgc);
}

uint8_t
create2_cell_body_getconst_handshake_data(const create2_cell_body_t *inp, size_t vgc)
{
  return create2_cell_body_get_handshake_data((create2_cell_body_t*)inp, vgc);
}
int
create2_cell_body_set_handshake_data(create2_cell_body_t *inp, size_t vgc, uint8_t elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->handshake_data, vgc, elt);
  return 0;
}
int
...
uint8_t
ed25519_cert_extension_get_un_signing_key(ed25519_cert_extension_t *inp, size_t vgc)
{
  trunnel_assert(vgc < 32);
  return inp->un_signing_key[vgc];
}

uint8_t
ed25519_cert_extension_getconst_un_signing_key(const ed25519_cert_extension_t *inp, size_t vgc)
{
  return ed25519_cert_extension_get_un_signing_key((ed25519_cert_extension_t*)inp, vgc);
}
int
ed25519_cert_extension_set_un_signing_key(ed25519_cert_extension_t *inp, size_t vgc, uint8_t elt)
{
  trunnel_assert(vgc < 32);
  inp->un_signing_key[vgc] = elt;
  return 0;
}
...
uint8_t
ed25519_cert_extension_get_un_unparsed(ed25519_cert_extension_t *inp, size_t vgc)
{
  return TRUNNEL_DYNARRAY_GET(&inp->un_unparsed, vgc);
}

uint8_t
ed25519_cert_extension_getconst_un_unparsed(const ed25519_cert_extension_t *inp, size_t vgc)
{
  return ed25519_cert_extension_get_un_unparsed((ed25519_cert_extension_t*)inp, vgc);
}
int
ed25519_cert_extension_set_un_unparsed(ed25519_cert_extension_t *inp, size_t vgc, uint8_t elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->un_unparsed, vgc, elt);
  return 0;
}
int
...
uint8_t
extend1_cell_body_get_onionskin(extend1_cell_body_t *inp, size_t vgc)
{
  trunnel_assert(vgc < 186);
  return inp->onionskin[vgc];
}

uint8_t
extend1_cell_body_getconst_onionskin(const extend1_cell_body_t *inp, size_t vgc)
{
  return extend1_cell_body_get_onionskin((extend1_cell_body_t*)inp, vgc);
}
int
extend1_cell_body_set_onionskin(extend1_cell_body_t *inp, size_t vgc, uint8_t elt)
{
  trunnel_assert(vgc < 186);
  inp->onionskin[vgc] = elt;
  return 0;
}
...
uint8_t
extend1_cell_body_get_identity(extend1_cell_body_t *inp, size_t vgc)
{
  trunnel_assert(vgc < 20);
  return inp->identity[vgc];
}

uint8_t
extend1_cell_body_getconst_identity(const extend1_cell_body_t *inp, size_t vgc)
{
  return extend1_cell_body_get_identity((extend1_cell_body_t*)inp, vgc);
}
int
extend1_cell_body_set_identity(extend1_cell_body_t *inp, size_t vgc, uint8_t elt)
{
  trunnel_assert(vgc < 20);
  inp->identity[vgc] = elt;
  return 0;
}
...
uint8_t
link_specifier_get_un_ipv6_addr(link_specifier_t *inp, size_t vgc)
{
  trunnel_assert(vgc < 16);
  return inp->un_ipv6_addr[vgc];
}

uint8_t
link_specifier_getconst_un_ipv6_addr(const link_specifier_t *inp, size_t vgc)
{
  return link_specifier_get_un_ipv6_addr((link_specifier_t*)inp, vgc);
}
int
link_specifier_set_un_ipv6_addr(link_specifier_t *inp, size_t vgc, uint8_t elt)
{
  trunnel_assert(vgc < 16);
  inp->un_ipv6_addr[vgc] = elt;
  return 0;
}
...
uint8_t
link_specifier_get_un_legacy_id(link_specifier_t *inp, size_t vgc)
{
  trunnel_assert(vgc < 20);
  return inp->un_legacy_id[vgc];
}

uint8_t
link_specifier_getconst_un_legacy_id(const link_specifier_t *inp, size_t vgc)
{
  return link_specifier_get_un_legacy_id((link_specifier_t*)inp, vgc);
}
int
link_specifier_set_un_legacy_id(link_specifier_t *inp, size_t vgc, uint8_t elt)
{
  trunnel_assert(vgc < 20);
  inp->un_legacy_id[vgc] = elt;
  return 0;
}
...
uint8_t
link_specifier_get_un_ed25519_id(link_specifier_t *inp, size_t vgc)
{
  trunnel_assert(vgc < 32);
  return inp->un_ed25519_id[vgc];
}

uint8_t
link_specifier_getconst_un_ed25519_id(const link_specifier_t *inp, size_t vgc)
{
  return link_specifier_get_un_ed25519_id((link_specifier_t*)inp, vgc);
}
int
link_specifier_set_un_ed25519_id(link_specifier_t *inp, size_t vgc, uint8_t elt)
{
  trunnel_assert(vgc < 32);
  inp->un_ed25519_id[vgc] = elt;
  return 0;
}
...
uint8_t
link_specifier_get_un_unrecognized(link_specifier_t *inp, size_t vgc)
{
  return TRUNNEL_DYNARRAY_GET(&inp->un_unrecognized, vgc);
}

uint8_t
link_specifier_getconst_un_unrecognized(const link_specifier_t *inp, size_t vgc)
{
  return link_specifier_get_un_unrecognized((link_specifier_t*)inp, vgc);
}
int
link_specifier_set_un_unrecognized(link_specifier_t *inp, size_t vgc, uint8_t elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->un_unrecognized, vgc, elt);
  return 0;
}
int
...
ed25519_cert_clear(ed25519_cert_t *obj)
{
  (void) obj;
  {
    ...
    unsigned vgc;
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->ext); ++vgc) {
      ed25519_cert_extension_free(TRUNNEL_DYNARRAY_GET(&obj->ext, vgc));
    }
  }
...
uint8_t
ed25519_cert_get_certified_key(ed25519_cert_t *inp, size_t vgc)
{
  trunnel_assert(vgc < 32);
  return inp->certified_key[vgc];
}

uint8_t
ed25519_cert_getconst_certified_key(const ed25519_cert_t *inp, size_t vgc)
{
  return ed25519_cert_get_certified_key((ed25519_cert_t*)inp, vgc);
}
int
ed25519_cert_set_certified_key(ed25519_cert_t *inp, size_t vgc, uint8_t elt)
{
  trunnel_assert(vgc < 32);
  inp->certified_key[vgc] = elt;
  return 0;
}
...
ed25519_cert_get_ext(ed25519_cert_t *inp, size_t vgc)
{
  return TRUNNEL_DYNARRAY_GET(&inp->ext, vgc);
}

 const struct ed25519_cert_extension_st *
ed25519_cert_getconst_ext(const ed25519_cert_t *inp, size_t vgc)
{
  return ed25519_cert_get_ext((ed25519_cert_t*)inp, vgc);
}
int
ed25519_cert_set_ext(ed25519_cert_t *inp, size_t vgc, struct ed25519_cert_extension_st * elt)
{
  ed25519_cert_extension_t *oldval = TRUNNEL_DYNARRAY_GET(&inp->ext, vgc);
  if (oldval && oldval != elt)
    ed25519_cert_extension_free(oldval);
  return ed25519_cert_set0_ext(inp, vgc, elt);
}
int
ed25519_cert_set0_ext(ed25519_cert_t *inp, size_t vgc, struct ed25519_cert_extension_st * elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->ext, vgc, elt);
  return 0;
}
int
...
uint8_t
ed25519_cert_get_signature(ed25519_cert_t *inp, size_t vgc)
{
  trunnel_assert(vgc < 64);
  return inp->signature[vgc];
}

uint8_t
ed25519_cert_getconst_signature(const ed25519_cert_t *inp, size_t vgc)
{
  return ed25519_cert_get_signature((ed25519_cert_t*)inp, vgc);
}
int
ed25519_cert_set_signature(ed25519_cert_t *inp, size_t vgc, uint8_t elt)
{
  trunnel_assert(vgc < 64);
  inp->signature[vgc] = elt;
  return 0;
}
...
ed25519_cert_check(const ed25519_cert_t *obj)
{
    ...
    return "Integer out of bounds";
  {
    ...
    unsigned vgc;
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->ext); ++vgc) {
      if (NULL != (msg = ed25519_cert_extension_check(TRUNNEL_DYNARRAY_GET(&obj->ext, vgc))))
        return msg;
    }
  }
...
ed25519_cert_encoded_len(const ed25519_cert_t *obj)
{
  ...
  /* Length of struct ed25519_cert_extension ext[n_extensions] */
  {
    ...
    unsigned vgc;
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->ext); ++vgc) {
      result += ed25519_cert_extension_encoded_len(TRUNNEL_DYNARRAY_GET(&obj->ext, vgc));
    }
  }
...
ed25519_cert_encode(uint8_t *output, const size_t avail, const ed25519_cert_t *obj)
{
  ...
  /* Encode struct ed25519_cert_extension ext[n_extensions] */
  {
    ...
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->ext); ++vgc) {
      trunnel_assert(written <= avail);
      result = ed25519_cert_extension_encode(ptr, avail - written, TRUNNEL_DYNARRAY_GET(&obj->ext, vgc));
      if (result < 0)
        goto fail; /* XXXXXXX !*/
...
ed25519_cert_parse_into(ed25519_cert_t *obj, const uint8_t *input, const size_t len_in)
{
  ...
  TRUNNEL_DYNARRAY_EXPAND(ed25519_cert_extension_t *, &obj->ext, obj->n_extensions, {});
  {
    ...
    unsigned vgc;
    for (vgc = 0; vgc < obj->n_extensions; ++vgc) {
...
extend2_cell_body_clear(extend2_cell_body_t *obj)
{
  (void) obj;
  {
    ...
    unsigned vgc;
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->ls); ++vgc) {
      link_specifier_free(TRUNNEL_DYNARRAY_GET(&obj->ls, vgc));
    }
  }
...
extend2_cell_body_get_ls(extend2_cell_body_t *inp, size_t vgc)
{
  return TRUNNEL_DYNARRAY_GET(&inp->ls, vgc);
}

 const struct link_specifier_st *
extend2_cell_body_getconst_ls(const extend2_cell_body_t *inp, size_t vgc)
{
  return extend2_cell_body_get_ls((extend2_cell_body_t*)inp, vgc);
}
int
extend2_cell_body_set_ls(extend2_cell_body_t *inp, size_t vgc, struct link_specifier_st * elt)
{
  link_specifier_t *oldval = TRUNNEL_DYNARRAY_GET(&inp->ls, vgc);
  if (oldval && oldval != elt)
    link_specifier_free(oldval);
  return extend2_cell_body_set0_ls(inp, vgc, elt);
}
int
extend2_cell_body_set0_ls(extend2_cell_body_t *inp, size_t vgc, struct link_specifier_st * elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->ls, vgc, elt);
  return 0;
}
int
...
extend2_cell_body_check(const extend2_cell_body_t *obj)
{
    ...
    return "A set function failed on this object";
  {
    ...
    unsigned vgc;
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->ls); ++vgc) {
      if (NULL != (msg = link_specifier_check(TRUNNEL_DYNARRAY_GET(&obj->ls, vgc))))
        return msg;
    }
  }
...
extend2_cell_body_encoded_len(const extend2_cell_body_t *obj)
{
  ...
  /* Length of struct link_specifier ls[n_spec] */
  {
    ...
    unsigned vgc;
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->ls); ++vgc) {
      result += link_specifier_encoded_len(TRUNNEL_DYNARRAY_GET(&obj->ls, vgc));
    }
  }
...
extend2_cell_body_encode(uint8_t *output, const size_t avail, const extend2_cell_body_t *obj)
{
  ...
  /* Encode struct link_specifier ls[n_spec] */
  {
    ...
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->ls); ++vgc) {
      trunnel_assert(written <= avail);
      result = link_specifier_encode(ptr, avail - written, TRUNNEL_DYNARRAY_GET(&obj->ls, vgc));
      if (result < 0)
        goto fail; /* XXXXXXX !*/
      written += result; ptr += result;
    }
...
link_specifier_list_clear(link_specifier_list_t *obj)
{
  (void) obj;
  {
    ...
    unsigned vgc;
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->spec); ++vgc) {
      link_specifier_free(TRUNNEL_DYNARRAY_GET(&obj->spec, vgc));
    }
  }
...
struct link_specifier_st *
link_specifier_list_get_spec(link_specifier_list_t *inp, size_t vgc)
{
  return TRUNNEL_DYNARRAY_GET(&inp->spec, vgc);
}

 const struct link_specifier_st *
link_specifier_list_getconst_spec(const link_specifier_list_t *inp, size_t vgc)
{
  return link_specifier_list_get_spec((link_specifier_list_t*)inp, vgc);
}
int
link_specifier_list_set_spec(link_specifier_list_t *inp, size_t vgc, struct link_specifier_st * elt)
{
  link_specifier_t *oldval = TRUNNEL_DYNARRAY_GET(&inp->spec, vgc);
  if (oldval && oldval != elt)
    link_specifier_free(oldval);
  return link_specifier_list_set0_spec(inp, vgc, elt);
}
int
link_specifier_list_set0_spec(link_specifier_list_t *inp, size_t vgc, struct link_specifier_st * elt)
{
  TRUNNEL_DYNARRAY_SET(&inp->spec, vgc, elt);
  return 0;
}
int
...
link_specifier_list_check(const link_specifier_list_t *obj)
{
    ...
    return "A set function failed on this object";
  {
    ...
    unsigned vgc;
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->spec); ++vgc) {
      if (NULL != (msg = link_specifier_check(TRUNNEL_DYNARRAY_GET(&obj->spec, vgc))))
        return msg;
    }
  }
...
link_specifier_list_encoded_len(const link_specifier_list_t *obj)
{
  ...
  /* Length of struct link_specifier spec[n_spec] */
  {
    ...
    unsigned vgc;
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->spec); ++vgc) {
      result += link_specifier_encoded_len(TRUNNEL_DYNARRAY_GET(&obj->spec, vgc));
    }
  }
  return result;
}
...
link_specifier_list_encode(uint8_t *output, const size_t avail, const link_specifier_list_t *obj)
{
  ...
  /* Encode struct link_specifier spec[n_spec] */
  {
    ...
    for (vgc = 0; vgc < TRUNNEL_DYNARRAY_LEN(&obj->spec); ++vgc) {
      trunnel_assert(written <= avail);
      result = link_specifier_encode(ptr, avail - written, TRUNNEL_DYNARRAY_GET(&obj->spec, vgc));
      if (result < 0)
        goto fail; /* XXXXXXX !*/
      written += result; ptr += result;
    }
